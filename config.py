...
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "6811427704:AAG0FSuwAgrfWCFtoZ0epZnBzl-DxUMF4Hs")
...
FORCE_SUB_1 = int(os.environ.get("FORCE_SUB_1", "-1001908614049"))
FORCE_SUB_2 = int(os.environ.get("FORCE_SUB_2", "-1002020156076"))
